...
export const categories: Category[] = [
  {
    ...
    movies: [
      ...
      {
        id: "a-marvel-television-special-presentation-the-punisher-one-last-kill",
        title: "A Marvel Television Special Presentation - The Punisher: One Last Kill",
        year: 2026,
        runtime: "51 min",
        rating: 8.6,
        poster: `${TMDB_IMG}/w500/gOggsBCSypNXq0yApYeXe7nnopT.jpg`,
        ...
        service: "Disney+",
        link: "https://www.disneyplus.com/sv-se/movies/a-marvel-television-special-presentation-the-punisher-one-last-kill"
      },
      {
        id: "apex",
        title: "Apex",
      ...
      },
      {
        ...
        runtime: "60 min",
        rating: 6.8,
        poster: `${TMDB_IMG}/w500/jtMuKwlOl4IzpB5fWn9RT9uyy6E.jpg`,
        backdrop: `${TMDB_IMG}/w1280/dzoqvi7eiPGODZO0CsXRLPfmVAE.jpg`,
        description: "Two friends go on a work trip and encounter unexpected challenges and local personalities as they navigate their assignment. Their efforts to adapt to unfamiliar surroundings highlights moments of hum...",
        service: "Disney+",
        link: "https://www.disneyplus.com/sv-se/movies/gary"
      },
      {
        id: "wall-e",
        title: "WALL·E",
