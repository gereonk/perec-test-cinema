...
export const categories: Category[] = [
  {
    ...
    movies: [
      ...
      },
      {
        ...
        runtime: "95 min",
        rating: 7.1,
        poster: `${TMDB_IMG}/w500/dj4MbmBrZXzNQpxsLBIxKohRp9b.jpg`,
        backdrop: `${TMDB_IMG}/w1280/5Dkv39CuytJDnJeZjkepFtOWqBr.jpg`,
        description: "When a last-minute chance to host the 1986 World Cup appears, a cunning Mexican bureaucrat, armed with nothing but guts and audacity, cons his way through FIFA to beat the United States, but in a coun...",
        service: "Netflix",
        link: "https://www.netflix.com/se/title/1530510"
      },
      {
        id: "wall-e",
        title: "WALL·E",
