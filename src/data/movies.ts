...
export const categories: Category[] = [
  {
    ...
    movies: [
      ...
      {
        id: "franco-escamilla-bienvenido-al-mundo",
        title: "Franco Escamilla: bienvenido al mundo",
        year: 2019,
        runtime: "54 min",
        rating: 8.5,
        poster: `${TMDB_IMG}/w500/h7rzOEh1gvGRIjehKnOHcMV0YQ3.jpg`,
        backdrop: `${TMDB_IMG}/w1280/wskGUSDuoqMthGykScl1ivROk8M.jpg`,
        ...
        service: "Netflix",
        link: "https://www.netflix.com/se/title/595723"
      },
      {
